...
import com.android.print.demo.service.BTPortService;
...
public class BluetoothOperation implements IPrinterOpertion {
    ...
    public void open(Intent data) {
        ...
        mPrinter = new BTPortService().btConnnect(mContext, mac, adapter, mHandler);
    ...
    public void btAutoConn(Context context, Handler mHandler) {
        ...
        mPrinter = new BTPortService().btAutoConn(context, adapter, mHandler);
    ...
    public void chooseDevice() {
        if (!adapter.isEnabled()) {
            ...
            ((Activity) mContext).startActivityForResult(enableIntent, MainActivity.ENABLE_BT);
        } else {
